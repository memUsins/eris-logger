...
var ConsoleAdapter = /** @class */ (function () {
    ...
    ConsoleAdapter.prototype.Format = function (log) {
        ...
        if ((_k = log.data) === null || _k === void 0 ? void 0 : _k.fields) {
            for (var _i = 0, _p = Object.keys((_l = log.data) === null || _l === void 0 ? void 0 : _l.fields); _i < _p.length; _i++) {
                var key = _p[_i];
                fieldsArray.push("".concat(key, "=").concat((_o = (_m = log.data) === null || _m === void 0 ? void 0 : _m.fields) === null || _o === void 0 ? void 0 : _o[key]));
            }
    ...
    ConsoleAdapter.prototype.setDefaultLevelsColorConfig = function (config) {
        ...
        var defaultColors = (_a = {},
            _a[log_interface_1.LogLevel.Debug] = 'gray',
            _a[log_interface_1.LogLevel.Info] = 'cyan',
            _a[log_interface_1.LogLevel.Alert] = 'cyanBright',
            _a[log_interface_1.LogLevel.Warn] = 'yellowBright',
            _a[log_interface_1.LogLevel.Error] = 'red',
            _a[log_interface_1.LogLevel.Fatal] = 'redBright',
            _a[log_interface_1.LogLevel.Unselected] = 'black',
            _a);
