...
var ErisLogger = /** @class */ (function () {
    function ErisLogger(config, defaultParams) {
        ...
        if (config.terminal && config.terminal.use) {
            config.terminal.colors && this.config.terminal ? (this.config.terminal = __assign(__assign({}, this.config.terminal), { colors: config.terminal.colors })) : false;
            config.terminal.levels && this.config.terminal ? (this.config.terminal = __assign(__assign({}, this.config.terminal), { levels: config.terminal.levels })) : false;
        }
    ...
    ErisLogger.prototype.warning = function (props) {
        ...
        if (((_b = (_a = this.config.options) === null || _a === void 0 ? void 0 : _a.levels) === null || _b === void 0 ? void 0 : _b.indexOf(logLevel)) === -1)
            return;
        this.isTerminalLogger(logLevel, function (color) { return console.warn(clc[color](_this.formatString(__assign(__assign({}, props), { params: _this.defaultParams })))); });
    ...
    ErisLogger.prototype.error = function (props) {
        ...
        if (((_b = (_a = this.config.options) === null || _a === void 0 ? void 0 : _a.levels) === null || _b === void 0 ? void 0 : _b.indexOf(logLevel)) === -1)
            return;
        this.isTerminalLogger(logLevel, function (color) { return console.error(clc[color](_this.formatString(__assign(__assign({}, props), { params: _this.defaultParams })))); });
