...
var ErisLogger = /** @class */ (function () {
    function ErisLogger(adapters) {
        ...
        if (!Array.isArray(adapters))
            adapters = [];
        if (!adapters.length)
            adapters.push(new adapters_1.ConsoleAdapter());
    ...
    ErisLogger.prototype.debug = function () {
        ...
        this.log(interfaces_1.newDefaultLog.apply(void 0, __spreadArray([interfaces_1.LogLevel.Debug], message, false)));
    };
    ErisLogger.prototype.info = function () {
        ...
        this.log(interfaces_1.newDefaultLog.apply(void 0, __spreadArray([interfaces_1.LogLevel.Info], message, false)));
    };
    ErisLogger.prototype.alert = function () {
        ...
        this.log(interfaces_1.newDefaultLog.apply(void 0, __spreadArray([interfaces_1.LogLevel.Alert], message, false)));
    };
    ErisLogger.prototype.warn = function () {
        ...
        this.log(interfaces_1.newDefaultLog.apply(void 0, __spreadArray([interfaces_1.LogLevel.Warn], message, false)));
    };
    ErisLogger.prototype.error = function () {
        ...
        this.log(interfaces_1.newDefaultLog.apply(void 0, __spreadArray([interfaces_1.LogLevel.Error], message, false)));
    };
    ErisLogger.prototype.fatal = function () {
        ...
        this.log(interfaces_1.newDefaultLog.apply(void 0, __spreadArray([interfaces_1.LogLevel.Fatal], message, false)));
    };
