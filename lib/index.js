...
var ErisLogger = /** @class */ (function () {
    function ErisLogger(config, defaultParams) {
        ...
        if ((_a = config.options) === null || _a === void 0 ? void 0 : _a.dateformat)
            this.dateformat = config.options.dateformat;
        if ((_b = config.terminal) === null || _b === void 0 ? void 0 : _b.use)
            this.terminal = new terminalLogger_1.TerminalLogger(__assign(__assign({}, config.terminal), { dateFormat: this.dateformat }));
        if ((_c = config.file) === null || _c === void 0 ? void 0 : _c.use)
            this.file = new fileLogger_1.FileLogger(config.file);
        if ((_d = config.options) === null || _d === void 0 ? void 0 : _d.levels)
