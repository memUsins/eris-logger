...
var wsLogger_1 = require("./wsLogger");
var ErisLogger = /** @class */ (function () {
    function ErisLogger(config, defaultParams) {
        ...
        if ((_e = config.ws) === null || _e === void 0 ? void 0 : _e.use)
            this.ws = new wsLogger_1.WSLogger(config === null || config === void 0 ? void 0 : config.ws);
        if ((_f = config.options) === null || _f === void 0 ? void 0 : _f.levels)
    ...
    ErisLogger.prototype.info = function (props) {
        ...
        (_c = this.ws) === null || _c === void 0 ? void 0 : _c.print(logLevel, props);
    };
